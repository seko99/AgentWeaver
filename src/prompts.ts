...
export const PLAN_PROMPT_TEMPLATE =
  ...
  "Используй дополнительные материалы из Jira attachments manifest {jira_attachments_manifest_file} и текстовый контекст {jira_attachments_context_file}, если они содержат релевантные данные для планирования. " +
